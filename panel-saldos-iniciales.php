<?php
  ...
  date_default_timezone_set('America/Mexico_City');
   ...
   $current_page_admin = "saldos-iniciales";
...
<html lang="es">
  <head>
    <title><?php echo $_SESSION['nombre-sitio']; ?> :: Saldos Iniciales</title>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-12">
                                    <a href="oper-saldos-iniciales.php?agre=add" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nuevo Saldo Inicial</a>
                                    <br>
                                    <br>
                                </div>
                            </div>
                                            ...
                                            if(mysqli_num_rows($QRY_GASTOS_FIJOS) > 0){
                                                while($f_gastosfijos = mysqli_fetch_array($QRY_GASTOS_FIJOS)){
                                                    ...
                                                    /*echo "<td><a href='oper_gasto_fijo.php?id=$f_gastosfijos[0]&agre=edit' class='btn btn-primary btn-xs'>Editar</a>
                                                            ...
                                                            echo "<td><button type='button' data-href='_eliminar_saldos_iniciales.php?id=$f_gastosfijos[0]' data-toggle='modal' data-target='#confirm-delete' class='btn btn-xs btn-danger'>Eliminar</button></td></tr>";
                                                }
                                                    echo "</tbody>
                                                            </table>";
                                            }else{
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Eliminar Saldo Inicial</h4>
                </div>
