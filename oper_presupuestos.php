...
<div class="container">
  <div class="row">
    <div class="col-xs-12">
      <h4><?php echo $operacion; ?> Presupuesto</h4><br>
    </div>
  </div>
  <?php 
  ...
  ?>
  <form action="_oper_presupuestos.php?oper=<?php echo $typeOper;?> " method="POST" name="frm_User" class="form-horizontal" enctype="multipart/form-data">
  <div class="row">
          ...
          <div class="col-xs-12">
            ...
            <label class="control-label col-md-4 col-xs-3">Descripcion</label>
              <div class="col-md-8 col-xs-9">
                ...
                <a href="panel-presupuestos.php" class='btn btn-danger'>Cancelar</a>
              </div>
            </div>
          </div>
        </div>              
