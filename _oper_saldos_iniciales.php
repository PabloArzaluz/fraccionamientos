<?php 
    ...
    if($oper == 'add'){
      $INSERTAR_SALDO_INICIAL = "insert into saldos_iniciales(descripcion,id_user,monto, fecha,fechacaptura) 
                                  values(
                                    '$descripcion',
                                    $usuario,
                                    '$monto',
      ...
      $INY_INSERTAR_SALDO_INICIAL = mysqli_query($mysqli,$INSERTAR_SALDO_INICIAL) or die(mysqli_error($mysqli));
