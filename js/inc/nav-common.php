<div class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Country del Lago</a>
        </div>
        <center>
            <div class="navbar-collapse collapse" id="navbar-main">
                <?php if(isset($_SESSION['id_user'])){ ?><ul class="nav navbar-nav">
                    ...
                    <li <?php if(isset($actual_page) && $actual_page == "comprobantes") echo "class='active'"; ?>><a href="comprobantes-pago.php">Comprobantes de Gasto</a>
                    </li>
                ...
                <?php }else{ ?>
                    <div class="navbar-right">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['name_user']; ?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <?php if($_SESSION['level_user']==1){ ?><li><a href="panel-avisos.php">Panel de Administrador</a>
                            </li> <?php } ?>
