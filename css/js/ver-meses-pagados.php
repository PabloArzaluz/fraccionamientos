...
(function ($, window, document, undefined) {
  ...
  $(document).ready(function() {
    ...
    $('#ok').click(function () {
      //  alert($('#mmp').mmp('value'));
      var datos = $('#mmp').mmp('value');
      $("#cadena").val(datos);
      $( "#frmCadena" ).submit();
    });

    $('#load').click(function () {
      window.location.replace("panel-estatus-mantenimiento.php");
    });
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <!--<a href="#" class="" id="load">Load</a>-->
        <br><button type="button" id="ok" class="btn btn-success btn-xs" onclick="javascript(location.href = 'www.yoursite.com';);">Guardar Registros</button>
        <button type="button" id="load" class="btn btn-danger btn-xs">Regresar / Cancelar</button>
    ...
    <div class="row">
      <div class="col-xs-8 col-xs-offset-2 col-sm-6  col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-5 text-center">
        ...
        <form name="cadena" class="cadena" type="POST" action="_pagar-meses.php?i=<?php echo $id_usuario; ?>">
          <input type="text" id="cadena" name="cadena"></input>
