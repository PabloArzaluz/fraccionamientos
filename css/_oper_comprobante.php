<?php 
   session_start();
    ...
    if($anoactual < $anotemp1) {
      $rutaGuarda = "Comprobantes/".$anoactual;
        ...
        mkdir($rutaGuarda,0777); 
                ...
                switch ($fecha) {
                  ...
                  echo "<SCRIPT LANGUAGE='javascript'>alert('Comprobante Guardado Presiona Ok Para continuar');document.location=('panel-comprobantes-gastos.php');</SCRIPT>";
