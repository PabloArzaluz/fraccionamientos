...
<html lang="es">
 ...
 <div class="container">
  ...
  <div class="container">
    <!--Encuestas en caso de que existan-->
    <?php
     $consultaInfoEncuesta = mysqli_query($mysqli,"SELECT * FROM encuestas where status=1;") or die(mysqli_error($mysqli));
     $f_InfoEncuesta = mysqli_num_rows($consultaInfoEncuesta);
     ...
     if($f_InfoEncuesta > 0){
      ...
      <div class="col-xs-12">
        <div class="panel panel-danger">
          <div class="panel-heading"><h4 class="panel-title" id="sin-salto-h">Encuestas</h4> <span class="label label-success">Nuevas</span></div>
            <div class="panel-body">
              <h3>Hay nuevas encuestas listas para ser contestadas, si aun no ha registrado su respuesta lo puede hacer <a href="encuestas.php">aqui</a></h3>
            </div>
          </div>
        </div>
      </div>
 ...
 $fechaActual = $ano."-".$mes."-01";
    ...
    if($cantidad[0] > 1){
      echo "Hasta el dia de hoy solo se llevan ";
