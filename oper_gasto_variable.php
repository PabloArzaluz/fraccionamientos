...
<html lang="es">
  <head>
    <title><?php echo $_SESSION['nombre-sitio']; ?> :: <?php echo $operacion; ?> Gasto Variable</title>
    ...
    <div class="row">
      <div class="col-xs-12">
        <ol class="breadcrumb">
          ...
          <li><a href="panel-gastos-variables.php">Panel de Administracion</a></li>
          <li class="active"><?php echo $operacion; ?> Gasto Variable</li>
        </ol>
      </div>
    </div>
  </div>
<div class="container">
  <div class="row">
    <div class="col-xs-12">
      <h4><?php echo $operacion; ?> Gasto Variable</h4><br>
    </div>
  </div>
  <?php 
  ...
  ?>
  <form action="_oper_gasto_variable.php?oper=<?php echo $typeOper;?> " method="POST" name="frm_User" class="form-horizontal" enctype="multipart/form-data">
    <div class="row">
          ...
          <div class="col-xs-12">
            <div class="form-group">
              ...
              <div class="col-md-8 col-xs-9">
                <input name="descripcion" id="tituloInpt" class="form-control" value= "<?php echo $descripcion; ?>" type="text" required placeholder="Descripcion de Gasto" />
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="col-lg-6 col-xs-12 text-right">
      ...
      <a href="panel-gastos-variables.php" class='btn btn-danger'>Cancelar</a>
      </div>
    </div>
  </div>
