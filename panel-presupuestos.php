  ...
  <head>
    ...
    function cambiarMes(){
      ...
      if(document.getElementById('generaFecha').options[document.getElementById('generaFecha').selectedIndex].value != ""){
        ...
        window.location = "panel-presupuestos.php?fecha="+fechaRequerida;
...
<br>
  ...
  <div class="row">
    ...
    <div class="col-xs-9">
      ...
      <a href="oper_presupuestos.php?agre=add" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Cargar Presupuesto</a>
    ...
    <div class="col-xs-3 text-right">
      ...
      <?php 
        ...
        $consulta_mes = mysqli_query($mysqli,"SELECT DISTINCT YEAR(fecha) AS anio, MONTH(fecha) AS mes
     FROM presupuestos
     WHERE fecha IS NOT NULL
     ORDER BY anio DESC, mes DESC;") or die(mysqli_error($mysqli));
        ...
        if(mysqli_num_rows($consulta_mes)>0){
          ...
          while($filaMes = mysqli_fetch_array($consulta_mes)){
            ...
            if($filaMes[1]=="11"){$filaMesNombre="Noviembre";}
  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="alert alert-success" role="alert">
        ...
        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Presupuesto Cargado Correctamente
...
//echo $fecha_entre;
  ...
  $consulta_noti = mysqli_query($mysqli,"SELECT * FROM presupuestos where fecha BETWEEN '$fechaRequerida' and '$fecha_entre';") or die(mysqli_error($mysqli));
  ...
  while($arr_comentarios = mysqli_fetch_array($consulta_noti)){ 
			...
			if($_SESSION['level_user'] == 1 )
              echo "<td><a href='delete-presupuestos.php?id=$arr_comentarios[0]&f=$fechaRequerida' class='btn btn-danger btn-xs'>Eliminar</a></td></tr>";
