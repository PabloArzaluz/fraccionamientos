...
<html lang="es">
  ...
  <head>
    ...
    <title>Estados de Cuenta :: <?php echo $_SESSION['nombre-sitio']; ?></title>
...
//echo $fecha_entre;
  ...
  $consulta_noti = mysqli_query($mysqli,"SELECT * FROM estados where fecha BETWEEN '$fechaRequerida' and '$fecha_entre';") or die(mysqli_error($mysqli));
