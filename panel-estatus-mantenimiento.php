              ...
              if(mysql_num_rows($conocer_estado_mantto)>0){
                ...
                if($row_mantto[0] >= $fechaActual){
                  echo "<tr class='success'>
                  			...
                  			<td>";
                  			if($arr_usuarios[3] == 1){
                  				echo "<input type='checkbox' name='stat' aria-label='...' checked onchange='pagaAdeudo($arr_usuarios[0])'> Presenta un Adeudo";
                  			}else{
                  				echo "<input type='checkbox' name='stat' aria-label='...' onchange='pagaAdeudo($arr_usuarios[0])'> Al corriente";
                  			}
                  			echo "</td>
                  			<td><a href='ver-meses-pagados.php?oper=edit&i=$arr_usuarios[0]&casa=$arr_usuarios[2]' class='btn btn-success btn-xs'>Pagar Otros Meses</a></td>
                  			</tr>";
                  }else{
                    ...
                    echo "<td><a href='ver-meses-pagados.php?oper=edit&i=$arr_usuarios[0]&casa=$arr_usuarios[2]' class='btn btn-success btn-xs'>Pagar Otros Meses</a></td></tr>";
                  }
                }else{
                  ...
                  echo "</td><td><a href='ver-meses-pagados.php?oper=edit&i=$arr_usuarios[0]&casa=$arr_usuarios[2]' class='btn btn-success btn-xs'>Pagar Otros Meses</a></td></tr>";
                }
            } 
