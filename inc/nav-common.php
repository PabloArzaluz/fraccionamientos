        ...
        <center>
            <div class="navbar-collapse collapse" id="navbar-main">
                ...
                <li <?php if(isset($actual_page) && $actual_page == "quejas") echo "class='active'"; ?>><a href="quejas-sugerencias.php">Quejas y Sugerencias</a>
                    ...
                    <li <?php if(isset($actual_page) && $actual_page == "encuestas") echo "class='active'"; ?>><a href="encuestas.php">Encuestas</a>
                ...
                <?php }else{ ?>
                    ...
                    <div class="navbar-right">
                        ...
                        <ul class="dropdown-menu">
                            <?php if($_SESSION['level_user']==1 || $_SESSION['level_user'] ==2 || $_SESSION['level_user'] ==3){ ?><li><a href="panel-avisos.php">Panel de Administrador</a>

                            </li> <?php } ?>

                            <li><a href="change_name.php">Cambiar Nombre</a>
