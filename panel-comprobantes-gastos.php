...
//echo $fecha_entre;
  ...
  $consulta_noti = mysqli_query($mysqli,"SELECT * FROM comprobantes where fecha BETWEEN '$fechaRequerida' and '$fecha_entre';") or die(mysqli_error($mysqli));
